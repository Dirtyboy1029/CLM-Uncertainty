...
file_path = '/common/home/yw1131/repos/BBBlora/checkpoints/blob/meta-llama/Llama-2-7b-hf/Source_Data/blob-Source_Data-sample10-eps0.05-kllr0.0025-beta0.05-gamma8-seed'
...
for dataset in datasets:
    input_strings = []
    file_path_new = file_path.replace('Source_Data', dataset)
...
# file_path = '/home/yibinwang/research/BBBlora/checkpoints/mcdropout/meta-llama/Llama-2-7b-hf/Source_Data/mcdropout-Source_Data-sample10-seed'
# for Source_Data in ['winogrande_s', 'ARC-Challenge', 'ARC-Easy', 'winogrande_m', 'obqa', 'boolq']:
# # for Source_Data in ['rte', 'mrpc', 'wic', 'cola', 'boolq']:
# # for Source_Data in ['winogrande_s']:
#     input_strings=[]
#     file_path_new = file_path.replace('Source_Data', Source_Data)
