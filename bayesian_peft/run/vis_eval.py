...
def vis_eval(model, dataset, accelerator, args: Namespace):
    ...
    Args:
        ...
        dataset: the Source_Data at hand
...
def main(args=None):
    ...
    # if args.laplace_vis:
    #     laplace_ood_vis(model, Source_Data, accelerator, args, ood_ori_dataset)
    # if args.ood_ori_dataset is not None and args.laplace_train:
    #     laplace_ood_eval(model, Source_Data, accelerator, args, ood_ori_dataset)
    # elif args.laplace_train:
    #     laplace_train_old(model, Source_Data, accelerator, args)
    # # elif args.atk:
    # #     atk(model, Source_Data, accelerator, args)
    # elif args.ood_ori_dataset is not None:
    #     ood_eval(model, Source_Data, accelerator, args, ood_ori_dataset)
    # else:
    #     train(model, Source_Data, accelerator, args)
